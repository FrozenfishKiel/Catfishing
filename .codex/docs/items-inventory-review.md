...
> **2026-09-15 盘点：2026-09-10 快照，已被取代。** 09-11 起 Inventory／Items 有十余个实现提交（删偷鱼协议、拿鱼收口、分架分库存档 v7），本文引用的 `TransferOwnedFish`、`BP_InitializeSlot`、存档 v5 拒鱼等已不存在；无人引用。留作历史。
