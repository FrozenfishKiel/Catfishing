...
提竿成功上鱼后，主持杆玩家自动切到第一人称拿杆视角。角力让杆停转时视角也停转，鼠标继续表达施力方向；反向回转或卸力后镜头随杆恢复。前后左右移动以实际杆/可见镜头为准。搏斗结束、离杆、断杆或失去角色控制后恢复原相机；协作者与旁观者的视角不切换。镜头构图可在项目设置 `Catfishing Fishing Presentation → Camera` 调整握把偏移和 FOV。
