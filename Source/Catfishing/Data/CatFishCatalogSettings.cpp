	...
	double& OutWeightKilograms) const
{
	...
	{
		UCatFishDefinition* Definition = DefinitionRef.LoadSynchronous();
		if (Definition && CatFishCatalogSettingsPrivate::PassesGate(*Definition, RegionId, TimeOfDay, Weather,
			ActivePlayerCount, CombinedFishingStrength, CombinedFightStamina))
		{
