...
public:
	...
	virtual const AActor* GetInventoryTransferAuthorityActor() const override { return this; }
	virtual UCatInventoryComponent* GetInventoryTransferInventory() const override { return InventoryComponent; }
...
private:
	...
	bool AddPreparedBatchToFormalInventory(const FCatInventoryReceiveBatch& ReceiveBatch);
	...
	bool bDeferringPublication = false;
