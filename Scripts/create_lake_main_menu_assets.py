"""在 Unreal Editor 中创建缺失的局内 ESC 菜单 WBP，并核验它的 View 绑定合同。
...
def main() -> None:
    """调用项目 Editor-only WBP 作者入口；菜单父类、按钮和状态文本合同任一失败都会向 Editor 日志抛出明确错误。"""
    ...
    unreal.log("Catfishing Lake main menu WBP was prepared without replacing existing layouts.")
